...
class MakeNodeCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $data['sftp_domain'] = $this->option('sftp_domain') ?? $this->ask('Enter a domain name (e.g. sftp.example.com or files.example.com) to be used for SFTP connections. An IP address may only be used if you are not using SSL/TLS for SFTP on this node');
        ...
        $data['daemonBase'] = $this->option('daemonBase') ?? $this->ask('Enter the base folder', '/var/lib/phoenixpanel/volumes');
