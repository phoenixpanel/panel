...
namespace PheonixPanel\Services\Backups;
...
use PheonixPanel\Extensions\Backups\BackupManager;
use PheonixPanel\Repositories\Eloquent\BackupRepository;
use PheonixPanel\Repositories\Wings\DaemonBackupRepository;
use PheonixPanel\Exceptions\Service\Backup\TooManyBackupsException;
...
class InitiateBackupService
{
     ...
     *
     * @throws \Throwable
     * @throws \PheonixPanel\Exceptions\Service\Backup\TooManyBackupsException
    ...
    public function handle(Server $server, string $name = null, bool $override = false): Backup
    {
        ...
        if (!$server->backup_limit || $successful->count() >= $server->backup_limit) {
            ...
            /** @var \PheonixPanel\Models\Backup $oldest */
        ...
        return $this->connection->transaction(function () use ($server, $name) {
            /** @var \PheonixPanel\Models\Backup $backup */
