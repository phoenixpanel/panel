...
use PheonixPanel\Contracts\Repository\DaemonKeyRepositoryInterface;
    ...
    public function up()
    {
        ...
        $subusers->each(function ($subuser) use (&$inserts) {
            $inserts[] = [
                ...
                'expires_at' => Carbon::now()->addMinutes(config('pheonixpanel.api.key_expire_time', 720))->toDateTimeString(),
