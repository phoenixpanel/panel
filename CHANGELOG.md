...
* Emails sending with 'PhoenixPanel Panel' as the from name. Now configurable by using `php artisan pheonixpanel:mail` to update.
...
* Panel now displays `PhoenixPanel Panel` as the company name if one is not set.
...
* Adds support for viewing SFTP password within the panel ([#74](https://github.com/PhoenixPanel/Panel/issues/74), thanks [@ET-Bent](https://github.com/ET-Bent))
...
### Fixed
* Fixes password auto-generation on 'Manage Server' page. ([#67](https://github.com/PhoenixPanel/Panel/issues/67), thanks [@ET-Bent](https://github.com/ET-Bent))
...
* Fixes the server name in the header not linking to the server correctly. ([#79](https://github.com/PhoenixPanel/Panel/issues/79), thanks [@xX1bumblebee1Xx](https://github.com/xX1bumblebee1Xx))
* Fixes bug where non-admins could not see command box on servers. ([#83](https://github.com/PhoenixPanel/Panel/issues/83), thanks [@xX1bumblebee1Xx](https://github.com/xX1bumblebee1Xx))
* Fixes bug where files could not be uploaded through the "click and select" system, only through "drag and drop." ([#82](https://github.com/PhoenixPanel/Panel/issues/83), thanks [@xX1bumblebee1Xx](https://github.com/xX1bumblebee1Xx))
* Fixes a bug where new files could not be created through the panel for a server. ([#85](https://github.com/PhoenixPanel/Panel/issues/85), thanks [@xX1bumblebee1Xx](https://github.com/xX1bumblebee1Xx))
* Fixes the exception handler to properly display and log exceptions that might occur rather than leaving a vague error. ([#81](https://github.com/PhoenixPanel/Panel/issues/83))

### Changed
* Update Laravel to version `5.3` and update dependencies.

### Deprecated
* Requires PhoenixPanel Daemon `v0.2.*`
