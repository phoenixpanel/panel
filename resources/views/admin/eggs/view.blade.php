                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="pExtraAllocations" class="control-label">Extra Allocations</label>
                                <input type="number" name="extra_allocations" id="pEggImageValue" class="form-control" value="{{ $egg->extra_allocations ?? 0 }}">
                                <p class="text-muted small">Provide a number of extra allocations per server.</p>
                            </div>
                        </div>
                    </div>
                </div>
