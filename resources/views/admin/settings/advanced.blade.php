...
@section('content-header')
    <h1>Advanced Settings<small>Configure advanced settings for PheonixPanel.</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="pheonixpanel:guzzle:connect_timeout" value="{{ old('pheonixpanel:guzzle:connect_timeout', config('pheonixpanel.guzzle.connect_timeout')) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input type="number" required class="form-control" name="pheonixpanel:guzzle:timeout" value="{{ old('pheonixpanel:guzzle:timeout', config('pheonixpanel.guzzle.timeout')) }}">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label class="control-label">Status</label>
                                <div>
                                    <select class="form-control" name="pheonixpanel:client_features:allocations:enabled">
                                        <option value="false">Disabled</option>
                                        <option value="true" @if(old('pheonixpanel:client_features:allocations:enabled', config('pheonixpanel.client_features.allocations.enabled'))) selected @endif>Enabled</option>
                                    </select>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="pheonixpanel:client_features:allocations:range_start" value="{{ old('pheonixpanel:client_features:allocations:range_start', config('pheonixpanel.client_features.allocations.range_start')) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input type="number" class="form-control" name="pheonixpanel:client_features:allocations:range_end" value="{{ old('pheonixpanel:client_features:allocations:range_end', config('pheonixpanel.client_features.allocations.range_end')) }}">
