        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="sftp_domain" class="control-label">SFTP Domain Name</label>
                        <div>
                            <input type="text" autocomplete="off" name="sftp_domain" class="form-control" value="{{ old('sftp_domain', $node->sftp_domain) }}" />
                        </div>
                        <p class="text-muted"><small>Please enter the domain name (e.g. <code>sftp.example.com</code> or <code>files.example.com</code>) to be used for SFTP connections. An IP address may only be used if you are not using SSL/TLS for SFTP on this node.
                                <a tabindex="0" data-toggle="popover" data-trigger="focus" title="Why do I need an SFTP domain?" data-content="To secure SFTP communications, it's recommended to use SSL/TLS. We cannot generate SSL/TLS certificates for IP Addresses, so a domain name is preferred.">Why?</a>
                            </small></p>
                    </div>
                    <div class="form-group col-xs-12">
