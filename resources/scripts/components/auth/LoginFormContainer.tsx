...
export default forwardRef<HTMLFormElement, Props>(({ title, ...props }, ref) => {
    ...
    return (
        <Container>
            ...
            <Form {...props} ref={ref}>
                <div
                    css={tw`md:flex w-full bg-neutral-800 shadow-lg rounded-lg p-6 md:pl-0 mx-1 border border-phoenix-900`}
                >
                    ...
                    <div css={tw`flex-1`}>
                        ...
                        {/* Captcha Component */}
                        <div css={tw`mt-4`}>
                            {captchaType === 'cloudflare' ? <div>Cloudflare Captcha</div> : <div>Google Captcha</div>}
                        </div>
                    </div>
                </div>
            </Form>
