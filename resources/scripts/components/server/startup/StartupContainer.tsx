          ...
          {Object.keys(data.dockerImages).length > 1 && !isCustomImage ? (
            <>
              ...
              <p css={tw`text-xs text-neutral-300 mt-2`}>
                This is an advanced feature allowing you to select a Docker image to use when running this server
                instance.
              </p>
            </>
          ) : (
            <>
              ...
              {isCustomImage && (
                <p css={tw`text-xs text-neutral-300 mt-2`}>
                  This {"server's"} Docker image has been manually set by an administrator and cannot be changed through
                  this UI.
                </p>
              )}
            </>
