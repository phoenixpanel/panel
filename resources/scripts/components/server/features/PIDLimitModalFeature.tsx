    ...
    >
      ...
      {isAdmin ? (
        <>
          ...
          <p css={tw`mt-4`}>
            Increasing <code css={tw`font-mono bg-neutral-900`}>container_pid_limit</code> in the wings configuration,{' '}
            <code css={tw`font-mono bg-neutral-900`}>config.yml</code>, might help resolve this issue.
          </p>
          <p css={tw`mt-4`}>
        ...
        <>
          ...
          <p css={tw`mt-4`}>
            This server is attempting to use more resources than allocated. Please contact the administrator and give
            them the error below.
          </p>
          <p css={tw`mt-4`}>
