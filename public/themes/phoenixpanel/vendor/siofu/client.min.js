...
(function (g, d, f) {
    ...
    return function (g) {
        var d = this;
        if (!window.File || !window.FileReader) throw Error('Socket.IO File Upload: Browser Not Supported');
        window.siofu_global || (window.siofu_global = { instances: 0, downloads: 0 });
        var f = {},
            p = {},
            y = {},
            q = {},
            h = {};
        d.fileInputElementId = 'siofu_input_' + siofu_global.instances++;
        d.resetFileInputs = !0;
        d.useText = !1;
        d.serializedOctets = !1;
        d.useBuffer = !0;
        d.chunkSize = 102400;
        var t = function (a, b) {
            ...
            C = function (a) {
                if (null !== d.maxFileSize && a.size > d.maxFileSize)
                    t('error', {
                        file: a,
                                ...
                                a: {
                                    ...
                                    if (!h)
                                        try {
                                            ...
                                            if (d.serializedOctets) e = l;
                                            else if (d.useBuffer) e = l.buffer;
                                            else {
                                                var n = !0,
                                                    m,
                                                ...
                                                2 === q % 3
                                                    ...
                                                    : 1 === q % 3 && (k = k.substring(0, k.length - 2) + '==');
                                                e = k;
                                            }
                                        } catch (E) {
        ...
        this.submitFiles = function (a) {
            a && u(a);
        };
        this.listenOnSubmit = function (a, b) {
            b.files &&
                e(
                    a,
                    'click',
        ...
        this.listenOnInput = function (a) {
            a.files && e(a, 'change', n, !1);
        };
        this.listenOnDrop = function (a) {
            e(
                a,
                'dragover',
                function (a) {
        ...
        this.prompt = function () {
            var a;
            a = document.getElementById(d.fileInputElementId);
            a ||
                ((a = document.createElement('input')),
                a.setAttribute('type', 'file'),
                a.setAttribute('id', d.fileInputElementId),
        ...
        this.destroy = function () {
            B();
            var a = document.getElementById(d.fileInputElementId);
            a && a.parentNode.removeChild(a);
            for (var b in h) h.hasOwnProperty(b) && (h[b].abort = !0);
            h = q = p = f = null;
        };
        ...
        this.removeEventListener = function (a, b) {
            if (!f[a]) return !1;
            for (var c = 0; c < f[a].length; c++) if (f[a][c] === b) return f[a].splice(c, 1), !0;
            return !1;
        };
        ...
        e(g, 'siofu_chunk', function (a) {
            if (y[a.id]) y[a.id]();
        });
        e(g, 'siofu_ready', function (a) {
            if (q[a.id]) q[a.id](a.name);
        });
        e(g, 'siofu_complete', function (a) {
            p[a.id] && t('complete', { file: p[a.id], detail: a.detail, success: a.success });
        });
        e(g, 'siofu_error', function (a) {
            p[a.id] && (t('error', { file: p[a.id], message: a.message, code: 0 }), h && (h[a.id].abort = !0));
        });
    };
});
