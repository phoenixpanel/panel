!(function (n, t) {
            ...
            return 0 === o
                ...
                : ((j[e] = o),
                  void Q(u, function (c) {
                      if (!n[c])
                          throw new Error(
                              'async.auto task `' + e + '` has a non-existent dependency in ' + u.join(', ')
                          );
                      i(c, function () {
                          o--, 0 === o && r(e, t);
                      });
    ...
    function ln(n, t) {
        ...
        G(n, function (n, t) {
            ...
            var u;
            if (Vt(n)) (u = Y(n)), (n = u.pop()), (e[t] = u.concat(u.length > 0 ? r : n));
        ...
        return (
            ...
            Vt(n)
                ? n.length
                    ...
                    : t()
                : t(new TypeError('First argument to race must be an array of functions'))
        );
    }
    function Nn(n, t, e, r) {
    ...
    function Jn(n, t, e) {
        function r(n, t) {
            if ('object' == typeof t)
                (n.times = +t.times || i),
                    (n.intervalFunc = 'function' == typeof t.interval ? t.interval : Hn(+t.interval || o));
            else {
        ...
        if (
            (arguments.length < 3 && 'function' == typeof n ? ((e = t || y), (t = n)) : (r(c, n), (e = e || y)),
            'function' != typeof t)
        )
