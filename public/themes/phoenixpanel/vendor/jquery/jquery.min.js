...
!(function (a, b) {
    ...
    r.extend({
        ...
        when: function (a) {
            ...
            if (
                b <= 1 &&
                (O(a, g.done(h(c)).resolve, g.reject), 'pending' === g.state() || r.isFunction(e[c] && e[c].then))
            )
                return g.then();
        ...
        r.each(['height', 'width'], function (a, b) {
            r.cssHooks[b] = {
                ...
                set: function (a, c, d) {
                    ...
                    return (
                        g && (e = aa.exec(c)) && 'px' !== (e[3] || 'px') && ((a.style[b] = c), (c = r.css(a, b))),
                        Va(a, c, g)
                    );
                },
            };
    ...
    function fb(a, b, c) {
        ...
        if (((i = !r.isEmptyObject(b)), i || !r.isEmptyObject(n))) {
            l &&
                ...
                (k = r.css(a, 'display')),
                'none' === k &&
                    (j ? (k = j) : (ha([a], !0), (j = a.style.display || j), (k = r.css(a, 'display')), ha([a]))),
    ...
    (r.Animation = r.extend(hb, {
        ...
        (r.fx.start = function () {
            $a ||
                ($a = a.requestAnimationFrame ? a.requestAnimationFrame(bb) : a.setInterval(r.fx.tick, r.fx.interval));
        }),
        (r.fx.stop = function () {
