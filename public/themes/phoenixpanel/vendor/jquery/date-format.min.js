    ...
    a.format = (function () {
        ...
        function l(a) {
            var b,
                ...
                h = '';
            return (
                -1 !== g.indexOf('.') && ((e = g.split('.')), (g = e[0]), (h = e[e.length - 1])),
                (f = g.split(':')),
                3 === f.length
                    ? ((b = f[0]),
                      (c = f[1]),
                      ...
                      { time: g, hour: b, minute: c, second: d, millis: h })
        ...
        return {
            parseDate: function (a) {
                var b,
                    c,
                    d = { date: null, year: null, month: null, dayOfMonth: null, dayOfWeek: null, time: null };
                    ...
                    switch (((b = a.split(' ')), 6 === b.length && isNaN(b[5]) && (b[b.length] = '()'), b.length)) {
                        ...
                        case 1:
                            (c = b[0].split('')),
                                ...
                                (d.time = l(c[13] + c[14] + c[15] + c[16] + c[17] + c[18] + c[19] + c[20]));
                            break;
                        default:
                            return null;
                    }
                        ...
                        if (r) "'" == t ? ((p += '' === o ? "'" : o), (o = ''), (r = !1)) : (o += t);
                            ...
                            switch (((o += t), (q = ''), o)) {
                                ...
                                case 'H':
                                    ...
                                    break;
                                case 'hh':
                                    (e = 0 === parseInt(n.hour, 10) ? 12 : n.hour < 13 ? n.hour : n.hour - 12),
                                        (p += m(e, 2)),
                                        (o = '');
                                    break;
                                case 'h':
