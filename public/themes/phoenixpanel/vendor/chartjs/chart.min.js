                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                ...
                                calculateBarBase: function (t, e) {
                                    ...
                                    if (n.options.stacked) {
                                        for (
                                            var r = a.chart, l = r.data.datasets, s = Number(l[t].data[e]), d = 0;
                                            t > d;
                                            d++
                                        ) {
                                            var u = l[d],
                                    ...
                                    e.extend(t, {
                                        ...
                                        _model: {
                                            ...
                                            backgroundColor: d.backgroundColor
                                                ? d.backgroundColor
                                                : e.getValueAtIndexOrDefault(u.backgroundColor, a, c.backgroundColor),
                                            borderSkipped: d.borderSkipped ? d.borderSkipped : c.borderSkipped,
                                            borderColor: d.borderColor
                                                ? d.borderColor
                                                : e.getValueAtIndexOrDefault(u.borderColor, a, c.borderColor),
                                            borderWidth: d.borderWidth
                                                ? d.borderWidth
                                                : e.getValueAtIndexOrDefault(u.borderWidth, a, c.borderWidth),
                                        },
                                        draw: function () {
                                            function t(t) {
                                                return s[(u + t) % 4];
                                ...
                                t.DatasetController.extend({
                                    ...
                                    update: function (t) {
                                        ...
                                        if (f < 2 * Math.PI) {
                                            ...
                                            var p = g + f,
                                                ...
                                                w = {
                                                    x: y
                                                        ? -1
                                                        : Math.min(m.x * (m.x < 0 ? 1 : S), b.x * (b.x < 0 ? 1 : S)),
                                                    y: k
                                                        ? -1
                                                        : Math.min(m.y * (m.y < 0 ? 1 : S), b.y * (b.y < 0 ? 1 : S)),
                                                },
                                                C = {
                                                    x: v
                                                        ? 1
                                                        : Math.max(m.x * (m.x > 0 ? 1 : S), b.x * (b.x > 0 ? 1 : S)),
                                                    y: x
                                                        ? 1
                                                        : Math.max(m.y * (m.y > 0 ? 1 : S), b.y * (b.y > 0 ? 1 : S)),
                                                },
                                        ...
                                        (i.borderWidth = a.getMaxBorderWidth(c.data)),
                                            ...
                                            (i.radiusLength =
                                                (i.outerRadius - i.innerRadius) / i.getVisibleDatasetCount()),
                                ...
                                updateElement: function (t, e, i) {
                                    ...
                                    void 0 !== d.radius && void 0 === d.pointRadius && (d.pointRadius = d.radius),
                                        ...
                                        (t._model = {
                                            ...
                                            pointStyle:
                                                s.pointStyle ||
                                                a.getValueAtIndexOrDefault(d.pointStyle, e, g.pointStyle),
                                            ...
                                            hitRadius:
                                                s.hitRadius ||
                                                a.getValueAtIndexOrDefault(d.pointHitRadius, e, g.hitRadius),
                                        });
                                },
                                ...
                                for (e = 0; l > e; ++e)
                                    (i = r[e]),
                                        i.model.skip ||
                                            ...
                                            n &&
                                                !n.model.skip &&
                                                (i.deltaK = (n.model.y - i.model.y) / (n.model.x - i.model.x)),
                                            !a || a.model.skip
                                                ? (i.mK = i.deltaK)
                                                : !n || n.model.skip
                                                ? (i.mK = a.deltaK)
                                ...
                                draw: function () {
                                    ...
                                    if (i.display) {
                                            ...
                                            x = function (e, a, n) {
                                                if (!(isNaN(b) || 0 >= b)) {
                                                    u.save(),
                                                        ...
                                                        (u.lineDashOffset = c(n.lineDashOffset, r.borderDashOffset)),
                                                    ...
                                                    if (
                                                        (u.setLineDash && u.setLineDash(c(n.lineDash, r.borderDash)),
                                        ...
                                        d = k
                                            ...
                                            : { x: a.left + n.padding, y: a.top + n.padding, line: 0 };
                                        var S = f + n.padding;
                                        e.each(a.legendItems, function (t, e) {
                                            ...
                                            k
                                                ? r + o >= l &&
                                                  ((c = d.y += S), d.line++, (r = d.x = a.left + (l - s[d.line]) / 2))
                                                : c + S > a.bottom &&
                                    ...
                                    if (
                                        ...
                                        if (u) {
                                            ...
                                            (a.paddingLeft = 0 !== a.labelRotation ? w * k + 3 : k / 2 + 3),
                                                (a.paddingRight = 0 !== a.labelRotation ? C * (c / 2) + 3 : S / 2 + 3);
                                        } else {
                                            var M = a.maxWidth - i.width,
                                                D = r.mirror;
                                            D ? (b = 0) : (b += a.options.ticks.padding),
                                                M > b ? (i.width += b) : (i.width = a.maxWidth),
                                                (a.paddingTop = c / 2),
                                                (a.paddingBottom = c / 2);
                                        }
                                    }
                                    ...
                                    if (a.isHorizontal()) {
                                        var i = a.width - (a.paddingLeft + a.paddingRight),
                                            n =
                                                i /
                                                Math.max(
                                                    a.ticks.length - (a.options.gridLines.offsetGridLines ? 0 : 1),
                                                    1
                                                ),
                                            o = n * t + a.paddingLeft;
                                        e && (o += n / 2);
                                ...
                                draw: function (a) {
                                    ...
                                    if (n.display) {
                                        ...
                                        if (
                                            (e.each(i.ticks, function (t, r) {
                                                if (void 0 !== t && null !== t) {
                                                    ...
                                                    if ((!s || l) && void 0 !== t && null !== t) {
                                                        var c, f;
                                                        r ===
                                                        ('undefined' != typeof i.zeroLineIndex ? i.zeroLineIndex : 0)
                                            ...
                                            if (g)
                                                (O = i.left + (i.right - i.left) / 2),
                                                    (B = 'bottom' === n.position ? i.bottom - C / 2 : i.top + C / 2);
                                            else {
                                                var z = 'left' === n.position;
                                                (O = z ? i.left + C / 2 : i.right - C / 2),
                                        ...
                                        if (u.drawBorder) {
                                            ...
                                            g
                                                ? ((E = U = 'top' === n.position ? i.bottom : i.top),
                                                  (E += q),
                                                  (U += q))
                                                : ((N = H = 'left' === n.position ? i.right : i.left),
                                                  (N += q),
                                                  (H += q)),
                                                l.beginPath(),
                                                l.moveTo(N, E),
            ...
            35: [
                function (t, e, a) {
                    ...
                    e.exports = function (t) {
                        var e = t.helpers,
                            a = t.defaults.global;
                        (a.elements.arc = { backgroundColor: a.defaultColor, borderColor: '#fff', borderWidth: 2 }),
                                                ...
                                                0 === c
                                                    ...
                                                    : ((f = -1 === u ? f : d[u]),
                                                      g.skip
                                                          ? o ||
                                                            u !== c - 1 ||
                                                            (l ? s.lineTo(r.x, r.y) : s.lineTo(f._view.x, r))
                                                          : (u !== c - 1
                                                                ? o && -1 !== u
                                                                    ? t(f, h)
                                                                    : l
                                    ...
                                    for (
                                        ...
                                        (h = d[c]),
                                            ...
                                            0 === c
                                                ...
                                                : ((f = -1 === u ? f : d[u]),
                                                  g.skip ||
                                                      ((u !== c - 1 && !o) || -1 === u ? s.moveTo(g.x, g.y) : t(f, h),
                                                      (u = c)));
                                    s.stroke(), s.restore();
                                },
                            }));
                        ...
                        var e = t.helpers,
                            ...
                            i = t.Scale.extend({
                                ...
                                getPixelForValue: function (t, e, a, i) {
                                    ...
                                    return (
                                        n.options.gridLines.offsetGridLines && i && (f += h / 2), n.top + Math.round(f)
                                    );
                                },
                                getPixelForTick: function (t, e) {
                                ...
                                determineDataLimits: function () {
                                    ...
                                    if (((a.min = null), (a.max = null), i.stacked)) {
                                        ...
                                        e.each(r, function (o, r) {
                                            ...
                                            void 0 === s[l.type] &&
                                                (s[l.type] = { positiveValues: [], negativeValues: [] });
                            ...
                            i = t.Scale.extend({
                                ...
                                buildTicks: function () {
                                    for (
                                        ...
                                        var l, s;
                                        0 === r
                                            ? ((l = Math.floor(e.log10(t.minNotZero))),
                                              (s = Math.round(t.minNotZero / Math.pow(10, l))))
                                            : ((l = Math.floor(e.log10(r))), (s = Math.floor(r / Math.pow(10, l)) + 1)),
                                            10 === s && ((s = 1), ++l),
                                            (r = s * Math.pow(10, l));
                                    }
                                    var d = n(i.max, r);
                                            ...
                                            : ((a = o.height - (s + d)),
                                              0 !== r || h.reverse
                                                  ? 0 === o.end && h.reverse
                                                      ...
                                                      : ((n = e.log10(o.end) - e.log10(r)),
                                                        (a = o.height - (s + d)),
                                                        (i = o.bottom - d - (a / n) * (e.log10(l) - e.log10(r))))
                                ...
                                fit: function () {
                                    ...
                                    for (this.ctx.font = v, i = 0; i < this.getValueCount(); i++) {
                                        (t = this.getPointPosition(i, x)),
                                            (n =
                                                this.ctx.measureText(this.pointLabels[i] ? this.pointLabels[i] : '')
                                                    .width + 5);
                                ...
                                o = t.Scale.extend({
                                    ...
                                    buildTicks: function () {
                                        ...
                                        if (
                                            ...
                                            for (var g = 0, p = a.units[g]; g < a.units.length; ) {
                                                ...
                                                var b = i.firstTick.diff(
                                                    ...
                                                    v = i
                                                        .getMomentStartOf(i.lastTick.clone().add(1, i.tickUnit))
                                        ...
                                        if (
                                            (i.options.time.min
                                                ...
                                                : ((i.firstTick = i.getMomentStartOf(i.firstTick)), (x = i.firstTick)),
                                            !i.options.time.max)
                                        ) {
                                            var y = i.getMomentStartOf(i.lastTick),
                                                k = y.diff(i.lastTick, i.tickUnit, !0);
                                            0 > k
                                                ? (i.lastTick = i.getMomentStartOf(i.lastTick.add(1, i.tickUnit)))
                                                : k >= 0 && (i.lastTick = y),
                                                (i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0));
                                        }
                                        ...
                                        (0 !== C || 0 === i.scaleSizeInUnits) &&
                                            (i.options.time.max
                                                ? (i.ticks.push(i.lastTick.clone()),
                                                  (i.scaleSizeInUnits = i.lastTick.diff(i.ticks[0], i.tickUnit, !0)))
                                                : (i.ticks.push(i.lastTick.clone()),
                                                  (i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0)))),
                                            i.ctx.restore(),
                                            (i.labelDiffs = void 0);
                                    ...
                                    getPixelForValue: function (t, e, a) {
                                        var i = this,
                                            n = null;
                                        if (
                                            (void 0 !== e && void 0 !== a && (n = i.getLabelDiff(a, e)),
                                            null === n &&
