    ...
    (String.format = function () {
        ...
        t.extend(e.prototype, {
                ...
                this.buildNotify(),
                    ...
                    (this.notify = {
                        ...
                        update: function (e, s) {
                            ...
                            var o =
                                this.$ele.outerHeight() + parseInt(t.settings.spacing) + parseInt(t.settings.offset.y);
                            t.reposition(o);
                        },
                        close: function () {
                            t.close();
            ...
            buildNotify: function () {
                ...
                (this.$ele = t(
                    String.format(this.settings.template, this.settings.type, e.title, e.message, e.url, e.target)
                )),
                    this.$ele.attr(
            ...
            placement: function () {
                ...
                this.$ele.css(i).addClass(this.settings.animate.enter),
                    ...
                    1 == this.settings.newest_on_top &&
                        ((s = parseInt(s) + parseInt(this.settings.spacing) + this.$ele.outerHeight()),
                        this.reposition(s)),
