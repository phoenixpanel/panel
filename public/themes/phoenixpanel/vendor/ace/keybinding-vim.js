define('ace/keyboard/vim', [
    ...
    function Q(e, t, n, r) {
        ...
        i.callback
            ? (s !== 'local' && i.callback(t, undefined), s !== 'global' && n && i.callback(t, n))
    ...
    function Mt(e, t) {
        return (
            arguments.length > 2 && (t = Mt.apply(undefined, Array.prototype.slice.call(arguments, 1))),
            Ot(e, t) ? e : t
        );
    }
    function _t(e, t) {
        return (
            arguments.length > 2 && (t = _t.apply(undefined, Array.prototype.slice.call(arguments, 1))),
            Ot(e, t) ? t : e
        );
    }
    function Dt(e, t, n) {
            ...
            i = function () {
                ...
                if (i) {
                    ...
                    (r = { line: r.line + d, ch: d ? r.ch : v + r.ch }),
                        n.visualLine && ((t = E(t.line, 0)), (r = E(r.line, Pt(e, r.line)))),
                        e.setSelection(t, r);
                }
                return [t, r];
            };
    ...
    function Ut(e, t) {
        var n = t.sel.anchor,
            r = t.sel.head;
        t.lastPastedText &&
            ((r = e.posFromIndex(e.indexFromPos(n) + t.lastPastedText.length)), (t.lastPastedText = null)),
            (t.lastSelection = {
    ...
    function sn(e, t, n, r, i, s) {
        ...
        var h = u.length != n,
            ...
            d = u.pop();
        return r && !i
            ? (!h && (p.from != o.ch || p.line != o.line) && (d = u.pop()), E(d.line, d.from))
            : r && i
            ? E(d.line, d.to - 1)
            : !r && i
            ? (!h && (p.to != o.ch || p.line != o.line) && (d = u.pop()), E(d.line, d.to))
            : E(d.line, d.from);
    }
    function on(e, t, n, r) {
        var i = e.getCursor(),
    ...
    function yn(e) {
        ...
        for (var s = -1; s < e.length; s++) {
            ...
            r
                ? ((o !== '\\' || !a) && i.push(o), (r = !1))
                : o === '\\'
                ? ((r = !0), u && n.indexOf(u) != -1 && (a = !0), (!a || u === '\\') && i.push(o))
                : (i.push(o), a && u !== '\\' && i.push('\\'));
        }
        return i.join('');
    }
    ...
    function qn(e) {
        ...
        !i &&
            ...
            (Zn(e, t, t.insertModeRepeat - 1, !0), (t.lastEditInputState.repeatOverride = t.insertModeRepeat)),
            ...
            e.operation(function () {
                e.ace.forEachSelection(function () {
                    ...
                    (s = St(s, 0, a)),
                        ...
                        (r = rr(e, t, n)),
                        (i.$desiredColumn = e.state.vim.lastHPos == -1 ? null : e.state.vim.lastHPos),
        ...
        function () {
            u.implement(v.prototype, s),
                ...
                (this.onChange = function (e) {
                    ...
                    n.changeHandlers ||
                        (n.changeHandlers = this._eventRegistry.change && this._eventRegistry.change.slice());
                    if (this.virtualSelectionMode()) return;
                    n.lastChange ? (n.lastChange.next = n.lastChange = t) : (n.lastChange = n.change = t),
                ...
                (this.onSelectionChange = function () {
                    ...
                    e.cursorActivityHandlers ||
                        ...
                        this.ace.inMultiSelectMode && this.ace.keyBinding.removeKeyboardHandler(p.keyboardHandler);
                }),
                (this.operation = function (e, t) {
                    ...
                    return (
                        this.ace.curOp &&
                            ...
                            (this.ace.endOperation(), !r.cursorActivity && !r.lastChange && n && (this.ace.prevOp = n)),
                        (t || !this.ace.curOp) && this.curOp && this.onBeforeEndOperation(),
                        i
                    );
                }),
        ...
        (function () {
            function e(e, t, n) {
                ...
                return (
                    ...
                    n ? (i.className = 'ace_dialog ace_dialog-bottom') : (i.className = 'ace_dialog ace_dialog-top'),
    ...
    v.defineOption('vimMode', !1, function (e, t, n) {
        t && e.getOption('keyMap') != 'vim'
            ? e.setOption('keyMap', 'vim')
            : !t && n != v.Init && /^vim/.test(e.getOption('keyMap')) && e.setOption('keyMap', 'default');
    });
        ...
        st = {
            ...
            defineEx: function (e, t, n) {
                if (!t) t = e;
                    ...
                    throw new Error(
                        '(Vim.defineEx) "' + t + '" is not a prefix of "' + e + '", command not registered'
                    );
        ...
        (lt.prototype = {
                    ...
                    switch (t) {
                        ...
                        case 'change':
                            n.indexOf('\n') == -1
                                ...
                                : (this.shiftNumericRegisters_(), (this.registers[1] = new at(n, r)));
                    }
            ...
            getRegister: function (e) {
                return this.isValidRegister(e)
                    ? ((e = e.toLowerCase()), this.registers[e] || (this.registers[e] = new at()), this.registers[e])
    ...
    var ht = {
            matchCommand: function (e, t, n, r) {
                ...
                return (
                    s.keys.slice(-11) == '<character>' && (n.selectedCharacter = Ct(e)), { type: 'full', command: s }
                );
            },
            ...
            processSearch: function (e, t, n) {
                ...
                function l(t, n, i) {
                    var s = v.keyName(t),
                        o;
                    s == 'Up' || s == 'Down'
                        ? ((o = s == 'Up' ? !0 : !1), (n = nt.searchHistoryController.nextMatch(n, o) || ''), i(n))
                        : s != 'Left' &&
                          s != 'Right' &&
                          s != 'Ctrl' &&
                          s != 'Alt' &&
                ...
                function c(t, n, r) {
                    var i = v.keyName(t);
                    i == 'Esc' || i == 'Ctrl-C' || i == 'Ctrl-[' || (i == 'Backspace' && n == '')
                ...
                function i(t, n, r) {
                    ...
                    if (i == 'Esc' || i == 'Ctrl-C' || i == 'Ctrl-[' || (i == 'Backspace' && n == ''))
                        nt.exCommandHistoryController.pushInput(n),
                            ...
                            e.focus();
                    i == 'Up' || i == 'Down'
                        ? ((s = i == 'Up' ? !0 : !1), (n = nt.exCommandHistoryController.nextMatch(n, s) || ''), r(n))
                        : i == 'Ctrl-U'
                        ? (v.e_stop(t), r(''))
                        : i != 'Left' &&
                          i != 'Right' &&
            ...
            evalInput: function (e, t) {
                ...
                s && this.recordLastEdit(t, n),
                    n.repeatOverride !== undefined ? (v = n.repeatOverride) : (v = n.getRepeat());
                if (v > 0 && i.explicitRepeat) i.repeatIsExplicit = !0;
                else if (i.noRepeat || (!i.explicitRepeat && v === 0)) (v = 1), (i.repeatIsExplicit = !1);
                n.selectedCharacter && (i.selectedCharacter = o.selectedCharacter = n.selectedCharacter),
                    (i.repeat = v),
                    ut(e);
                if (r) {
                    var m = pt[r](e, f, i, t);
        ...
        pt = {
            ...
            moveByLines: function (e, t, n, r) {
                ...
                return (
                    l && (n.forward ? u > l.start.row && (u = l.end.row + 1) : (u = l.start.row)),
            ...
            change: function (e, t, n) {
                ...
                if (!s.visualMode) {
                    ...
                    u.line > e.lastLine() && t.linewise && !c ? e.replaceRange('', l, u) : e.replaceRange('', o, u),
                        t.linewise &&
                            (c || (e.setCursor(l), v.commands.newlineAndIndent(e)), (o.ch = Number.MAX_VALUE)),
                        (r = o);
                } else {
                    i = e.getSelection();
                    var h = vt('', n.length);
            ...
            delete: function (e, t, n) {
                ...
                if (!s.visualBlock) {
                    ...
                    t.linewise &&
                        ...
                        o.line == e.lastLine() &&
                        o.line == u.line - 1 &&
                        (o.line == e.firstLine() ? (o.ch = 0) : (o = E(o.line - 1, Pt(e, o.line - 1)))),
                        (i = e.getRange(o, u)),
                        e.replaceRange('', o, u),
                        (r = o),
        ...
        yt = {
            ...
            enterInsertMode: function (e, t, n) {
                ...
                if (r == 'eol') s = E(s.line, Pt(e, s.line));
                    ...
                    n.visualBlock
                        ? ((s = E(Math.min(i.head.line, i.anchor.line), Math.min(i.head.ch, i.anchor.ch))),
                    ...
                    n.visualBlock
                        ? ((s = E(Math.min(i.head.line, i.anchor.line), Math.max(i.head.ch + 1, i.anchor.ch))),
                          (o = Math.abs(i.head.line - i.anchor.line) + 1))
                        : i.head.line >= i.anchor.line
                        ? (s = St(i.head, 0, 1))
                        : (s = E(i.anchor.line, 0));
                ...
                e.setOption('keyMap', 'vim-insert'),
                    ...
                    t && t.replace
                        ...
                        : (e.setOption('keyMap', 'vim-insert'), v.signal(e, 'vim-mode-change', { mode: 'insert' })),
                    nt.macroModeState.isPlaying || (e.on('change', $n), v.on(e.getInputField(), 'keydown', Yn)),
                    n.visualMode && $t(e),
                    It(e, s, o);
            },
                ...
                if (n.visualMode) {
                    ...
                    n.lastSelection && (y = n.lastSelection.headMark.find()),
                        ...
                        d
                            ? (e.replaceSelections(N),
                              ...
                              (m = w))
                            : n.visualBlock
                            ? (e.replaceSelections(N), e.setCursor(w), e.replaceRange(s, w, w), (m = w))
                            : (e.replaceRange(s, w, S), (m = e.posFromIndex(e.indexFromPos(w) + s.length - 1))),
                    ...
                    e.replaceRange(s, r),
                        p && t.after
                            ...
                            : !p && t.after
                            ? ((g = e.indexFromPos(r)), (m = e.posFromIndex(g + s.length - 1)))
            ...
            replace: function (e, t, n) {
                ...
                if (r == '\n')
                    ...
                    n.visualMode
                        ? ((i = Ot(u[0].anchor, u[0].head) ? u[0].anchor : u[0].head), e.setCursor(i), $t(e, !1))
    ...
    Bn.prototype = {
            ...
            t.eatWhile(':'),
                t.eat('%')
                    ...
                    : ((n.line = this.parseLineSpec_(e, t)),
                      n.line !== undefined && t.eat(',') && (n.lineEnd = this.parseLineSpec_(e, t)));
            var r = t.match(/^(\w+)/);
        ...
        map: function (e, t, n) {
            if (e != ':' && e.charAt(0) == ':') {
                ...
                var r = e.substring(1);
                t != ':' && t.charAt(0) == ':'
                    ? (this.commandMap_[r] = { name: r, type: 'exToEx', toInput: t.substring(1), user: !0 })
    ...
    var jn = {
            ...
            substitute: function (e, t) {
                ...
                if (r.length)
                    (i = r[0]),
                        (s = r[1]),
                        s !== undefined && (G('pcre') ? (s = Sn(s)) : (s = wn(s)), (nt.lastSubstituteReplacePart = s)),
                        (o = r[2] ? r[2].split(' ') : []);
                else if (n && n.length) {
    ...
    t.handler = {
        ...
        handleKeyboard: function (e, t, n, r, i) {
            ...
            if (t == -1 || t & 1 || (t === 0 && n.length > 1)) {
                ...
                var l = sr(o, f, 'user');
                (u = or(o)),
                    l && u.status != null ? (u.status += f) : u.status == null && (u.status = ''),
    ...
    S.defineOption(
        ...
        b.push(
            ...
            { keys: 'zC', type: 'action', action: 'fold', actionArgs: { open: !1, all: !0 } },
            { keys: 'zo', type: 'action', action: 'fold', actionArgs: { open: !0 } },
            { keys: 'zO', type: 'action', action: 'fold', actionArgs: { open: !0, all: !0 } },
            { keys: 'za', type: 'action', action: 'fold', actionArgs: { toggle: !0 } },
            { keys: 'zA', type: 'action', action: 'fold', actionArgs: { toggle: !0, all: !0 } },
            { keys: 'zf', type: 'action', action: 'fold', actionArgs: { open: !0, all: !0 } },
            { keys: 'zd', type: 'action', action: 'fold', actionArgs: { open: !0, all: !0 } },
        ...
        (yt.fold = function (e, t, n) {
            e.ace.execCommand(
                ['toggleFoldWidget', 'toggleFoldWidget', 'foldOther', 'unfoldall'][(t.all ? 2 : 0) + (t.open ? 1 : 0)]
            );
        }),
