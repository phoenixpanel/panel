define(
    ...
    function (e, t, n) {
                    ...
                    '#comments': [
                        {
                            ...
                            regex: /\/\*/,
                            push: [
                                { token: 'punctuation.definition.comment.kotlin', regex: /\*\//, next: 'pop' },
                    ...
                    '#strings': [
                        {
                            ...
                            regex: /"""/,
                            push: [
                                { token: 'punctuation.definition.string.end.kotlin', regex: /"""/, next: 'pop' },
                                { token: 'variable.parameter.template.kotlin', regex: /\$\w+|\$\{[^\}]+\}/ },
        ...
        (s.metaData = { fileTypes: ['kt', 'kts'], name: 'Kotlin', scopeName: 'source.Kotlin' }),
            r.inherits(s, i),
