        ...
        var routes = {
            ...
            routes: [
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersBaseSecurityController@generateTotp',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersBaseSecurityController@disableTotp',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    uri: 'admin/settings',
                    name: 'admin.settings',
                    action: 'PhoenixPanelHttpControllersAdminSettingsIndexController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminSettingsMailController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersAdminSettingsAdvancedController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminSettingsAdManagerController@index',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'admin/settings/adsmanager',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminSettingsAdManagerController@update',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'admin/settings',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminSettingsIndexController@update',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'admin/settings/mail',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminSettingsMailController@update',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'admin/settings/advanced',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminSettingsAdvancedController@update',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@viewDetails',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@viewStartup',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@viewDatabase',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@viewManage',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@viewDelete',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    uri: 'admin/servers/view/{server}/build',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminServersController@updateBuild',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'admin/servers/view/{server}/startup',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminServersController@saveStartup',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'admin/servers/view/{server}/database',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminServersController@newDatabase',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@toggleInstall',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@rebuildContainer',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@manageSuspension',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@reinstallServer',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    uri: 'admin/servers/view/{server}/details',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminServersController@setDetails',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'admin/servers/view/{server}/database',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminServersController@resetDatabasePassword',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminServersController@deleteDatabase',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNodesController@viewSettings',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNodesController@viewConfiguration',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNodesController@viewAllocation',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    uri: 'admin/nodes/view/{node}/allocation',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminNodesController@createAllocation',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNodesController@allocationRemoveBlock',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNodesController@allocationSetAlias',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'admin/nodes/view/{node}/settings',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminNodesController@updateSettings',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNodesController@allocationRemoveSingle',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNodesController@allocationRemoveMultiple',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNestsEggShareController@export',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNestsEggVariableController@view',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNestsEggScriptController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNestsEggShareController@import',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    uri: 'admin/nests/egg/{egg}/variables',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminNestsEggVariableController@store',
                },
                {
                    host: null,
                    methods: ['PUT'],
                    uri: 'admin/nests/egg/{egg}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminNestsEggShareController@update',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                ...
                },
                {
                    ...
                    uri: 'admin/nests/egg/{egg}/scripts',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminNestsEggScriptController@update',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    ...
                    action: 'PhoenixPanelHttpControllersAdminNestsEggVariableController@update',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                ...
                },
                {
                    ...
                    uri: 'admin/nests/egg/{egg}/variables/{variable}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAdminNestsEggVariableController@destroy',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    uri: 'auth/login',
                    name: 'auth.login',
                    action: 'PhoenixPanelHttpControllersAuthLoginController@showLoginForm',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    uri: 'auth/password',
                    name: 'auth.password',
                    action: 'PhoenixPanelHttpControllersAuthForgotPasswordController@showLinkRequestForm',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    name: 'auth.reset',
                    action: 'PhoenixPanelHttpControllersAuthResetPasswordController@showResetForm',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    uri: 'auth/login/totp',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAuthLoginController@loginUsingTotp',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'auth/password',
                    name: null,
                    action: 'PhoenixPanelHttpControllersAuthForgotPasswordController@sendResetLinkEmail',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersAuthResetPasswordController@reset',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersServerSettingsAllocationController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerSettingsNameController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerSettingsSftpController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerSettingsStartupController@index',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'server/{server}/settings/allocation',
                    name: null,
                    action: 'PhoenixPanelHttpControllersServerSettingsAllocationController@update',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'server/{server}/settings/name',
                    name: null,
                    action: 'PhoenixPanelHttpControllersServerSettingsNameController@update',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'server/{server}/settings/startup',
                    name: null,
                    action: 'PhoenixPanelHttpControllersServerSettingsStartupController@update',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersServerFilesFileActionsController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerFilesFileActionsController@create',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerFilesFileActionsController@view',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    name: 'server.files.edit',
                    action: 'PhoenixPanelHttpControllersServerFilesDownloadController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerFilesRemoteRequestController@directory',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerFilesRemoteRequestController@store',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersServerTasksTaskManagementController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerTasksTaskManagementController@create',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'server/{server}/schedules/new',
                    name: null,
                    action: 'PhoenixPanelHttpControllersServerTasksTaskManagementController@store',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerTasksTaskManagementController@view',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'server/{server}/schedules/view/{schedule}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersServerTasksTaskManagementController@update',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerTasksActionController@toggle',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersServerTasksActionController@trigger',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    uri: 'server/{server}/schedules/view/{schedule}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersServerTasksTaskManagementController@delete',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationUsersUserController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationUsersUserController@view',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationUsersExternalUserController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'api/application/users',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationUsersUserController@store',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'api/application/users/{user}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationUsersUserController@update',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    uri: 'api/application/users/{user}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationUsersUserController@delete',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesNodeController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesNodeController@view',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'api/application/nodes',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesNodeController@store',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'api/application/nodes/{node}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesNodeController@update',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    uri: 'api/application/nodes/{node}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesNodeController@delete',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesAllocationController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'api/application/nodes/{node}/allocations',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesAllocationController@store',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNodesAllocationController@delete',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationLocationsLocationController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationLocationsLocationController@view',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'api/application/locations',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationLocationsLocationController@store',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    uri: 'api/application/locations/{location}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationLocationsLocationController@update',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    uri: 'api/application/locations/{location}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationLocationsLocationController@delete',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerController@view',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersExternalServerController@index',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerDetailsController@details',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerDetailsController@build',
                },
                {
                    host: null,
                    methods: ['PATCH'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersStartupController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'api/application/servers',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerController@store',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerManagementController@suspend',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerManagementController@unsuspend',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerManagementController@reinstall',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerManagementController@rebuild',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    uri: 'api/application/servers/{server}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationServersServerController@delete',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersDatabaseController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationServersDatabaseController@view',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'api/application/servers/{server}/databases',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationServersDatabaseController@store',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationServersDatabaseController@resetPassword',
                },
                {
                    host: null,
                    methods: ['DELETE'],
                    uri: 'api/application/servers/{server}/databases/{database}',
                    name: null,
                    action: 'PhoenixPanelHttpControllersApiApplicationServersDatabaseController@delete',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNestsNestController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNestsNestController@view',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNestsEggController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiApplicationNestsEggController@view',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersApiClientServersServerController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiClientServersResourceUtilizationController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiClientServersCommandController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiClientServersPowerController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiRemoteValidateKeyController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiRemoteFileDownloadController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiRemoteEggRetrievalController@index',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiRemoteEggRetrievalController@download',
                },
                {
                    host: null,
                    methods: ['GET', 'HEAD'],
                    ...
                    action: 'PhoenixPanelHttpControllersApiRemoteEggInstallController@index',
                },
                {
                    host: null,
                    methods: ['POST'],
                ...
                },
                {
                    ...
                    action: 'PhoenixPanelHttpControllersDaemonActionController@configuration',
                },
                {
                    host: null,
                    methods: ['POST'],
                    uri: 'daemon/install',
                    name: 'daemon.install',
                    action: 'PhoenixPanelHttpControllersDaemonActionController@markInstall',
                },
            ],
            prefix: '',
